# Headline metrics (as of 2026-07-23)
...
- 2026 YTD: 45% of 168 decided (CI 37%-53%)
- 2025: 30% of 96 decided (CI 20%-40%)

## Political context
- Incident share in Trump-won counties: 66% (n=895)
...
- 118 rows have no usable date and are absent from all temporal statistics; these skew toward the newest intake stream, so recent-period counts are floors.
