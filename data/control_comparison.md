...
Generated 2026-07-10 by `control_comparison.py`. All figures re-derived from the current CSVs at generation time.
...
- Opposed projects (treatment side): **176**, of which 80 decided / 96 pending
- Eligible control pool: **1460** — proposals_unopposed: 95, ai_centers: 20, atlas: 1345
- Excluded from control pool: **199** — county_shared_with_opposed_project: 158, within_15km_of_opposed_project: 41
...
- `advanced_confirmed`: 55 (69%)
- `blocked_confirmed`: 25 (31%)
