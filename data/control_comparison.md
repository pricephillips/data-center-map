...
Generated 2026-09-24 by `control_comparison.py`. All figures re-derived from the current CSVs at generation time.
...
- Opposed projects (treatment side): **229**, of which 84 decided / 145 pending
- Eligible control pool: **1304** — proposals_unopposed: 77, ai_centers: 16, atlas: 1211
- Excluded from control pool: **360** — county_shared_with_opposed_project: 289, within_15km_of_opposed_project: 69, no_coordinates: 2
- Matched: **229** opposed projects × k=3 → 687 match rows
...
**all tiers** (687 match rows)
- County 2024 margin: opposed mean -0.118, control mean -0.124, SMD 0.022 — well balanced (n pairs: 654)
- log10 capacity MW: opposed mean 2.570, control mean 2.330, SMD 0.403 — IMBALANCED — down-weight or re-match (n pairs: 48; capacity is sparse outside the proposals tier)

**proposals_unopposed** (565 match rows)
- County 2024 margin: opposed mean -0.137, control mean -0.143, SMD 0.021 — well balanced (n pairs: 534)
- log10 capacity MW: opposed mean 2.565, control mean 2.321, SMD 0.407 — IMBALANCED — down-weight or re-match (n pairs: 47; capacity is sparse outside the proposals tier)
...
**atlas** (121 match rows)
- County 2024 margin: opposed mean -0.034, control mean -0.042, SMD 0.025 — well balanced (n pairs: 120)
...
- Opposed projects sit in counties with mean 2024 margin -0.118 (n=218); the eligible control pool mean is 0.048 (n=1275).
...
- `national_fallback` matches (no in-state pool): **358**, covering 164 opposed projects. Growing the proposals_unopposed tier is the fix.
- Tier usage across all matches: proposals_unopposed: 565, ai_centers: 1, atlas: 121.
