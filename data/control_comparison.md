...
- 8 decided+opposed projects have verified decision dates: announced-to-decision spans 12–205 days, median 156 days.
- Announced-date precision of these rows: month: 8. Month-precision announced dates are floored to the 1st, so those delays carry up to ~30 days of error each.
- `advanced_confirmed` (n=1): 119–119 days, median 119.
