...
Generated 2026-09-02. Gate thresholds registered 2026-07-27. This is the analysis layer over negative_audit.py; the audit frame design itself is registered separately and is not modified here.
...
| :-- | :-- | :-- | :-- |
| purposive (blocked_confirmed) | 14 | 9 | 64.3% |
| random (all other frame rows) | 162 | 0 | 0.0% |
...
9 of 14 coded. Findings: 6 verified_opposition, 1 verified_none, 2 undeterminable.
