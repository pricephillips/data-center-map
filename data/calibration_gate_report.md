...
Run 2026-09-14T20:25:47Z on `outcome_model` out-of-fold predictions.

## Verdict: **PROMOTE**

PASSED: ECE 0.148 <= 0.15, Brier skill 0.053 >= 0.05, discrimination ok

## Metrics

- Sample: 88 projects, 26 blocked (base rate 0.30)
- Brier score: **0.197** (base-rate baseline 0.208)
- Brier skill score: **0.053** (>0 beats the baseline; floor 0.05)
- Expected calibration error (ECE): **0.148** (ceiling 0.15)
- Discrimination (positives predicted higher than negatives): yes (mean pred: blocked 0.61 vs advanced 0.31)

## Reliability table (out-of-fold)

| Predicted bin | Projects | Mean predicted | Observed blocked |
|---|---|---|---|
| 0.0-0.2 | 36 | 0.09 | 0.14 |
| 0.2-0.4 | 12 | 0.31 | 0.17 |
| 0.4-0.6 | 11 | 0.46 | 0.27 |
| 0.6-0.8 | 16 | 0.73 | 0.44 |
| 0.8-1.0 | 13 | 0.89 | 0.69 |
