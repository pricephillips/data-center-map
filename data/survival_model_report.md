...
Generated 2026-08-17 by `survival_model.py`. Figures re-derived from current CSVs at generation time.
...
- Opposed projects in the model: **103** (24 reached a terminal decision = events; 79 still pending = right-censored).
