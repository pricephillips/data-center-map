...
Generated 2026-09-07 by `survival_model.py`. Figures re-derived from current CSVs at generation time.
...
- 57 opposed projects were EXCLUDED from the time axis because their announcement date is only year-precision (too coarse to floor without fabricating months).
