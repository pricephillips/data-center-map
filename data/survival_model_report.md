...
Generated 2026-08-12 by `survival_model.py`. Figures re-derived from current CSVs at generation time.
...
- Opposed projects in the model: **101** (24 reached a terminal decision = events; 77 still pending = right-censored).
...
- 55 opposed projects were EXCLUDED from the time axis because their announcement date is only year-precision (too coarse to floor without fabricating months).
