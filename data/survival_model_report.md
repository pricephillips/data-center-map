...
Generated 2026-08-10 by `survival_model.py`. Figures re-derived from current CSVs at generation time.
...
- Opposed projects in the model: **100** (24 reached a terminal decision = events; 76 still pending = right-censored).
