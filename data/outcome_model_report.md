...
Generated 2026-09-07 by `outcome_model.py`. All figures re-derived from current CSVs at generation time; the exact feature matrix is in `outcome_model_features.csv`.
...
- ROC-AUC across folds: **0.86** (10th–90th pct: 0.63–0.97). Chance = 0.50.
- Brier score across folds: **0.160** (10th–90th pct: 0.099–0.247). Predicting the base rate for everyone scores 0.208; lower is better.
...
- Predicted 0.33-0.67: 18 projects; mean predicted 0.49, observed blocked share 0.22
- Predicted 0.67-1.00: 21 projects; mean predicted 0.85, observed blocked share 0.76
...
- `mech_public_comment`: +0.181 (coef -1.38, toward advanced)
- `hyperscaler_involved`: +0.037 (coef -0.59, toward advanced)
- `capacity_missing`: +0.026 (coef +0.56, toward blocked)
- `days_to_first_opposition`: +0.024 (coef -0.46, toward advanced)
- `county_margin_2024`: +0.015 (coef +0.54, toward blocked)
- `log10_capacity_mw`: -0.012 (coef -0.04, toward advanced)
- `mech_legislation`: -0.011 (coef -0.06, toward advanced)
- `n_opposition_events`: +0.011 (coef -0.31, toward advanced)
